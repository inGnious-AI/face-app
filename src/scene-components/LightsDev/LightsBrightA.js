...
export const LightsBrightA = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.3, 1.98, 2.90], step: 0.01 },
    target: { value: [0, 1, 0], step: 0.01 },
    angle: { value: 0.4, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value:  0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value:11.50 , min: 0, max: 100, step: 0.01 },
    decay: { value: 1.85, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    target: { value:  [0, 0.24, 0], step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.50, 1.26, 1.11], step: 0.01 },
    target: { value: [-61.56, -23.88, -33.6], step: 0.01 },
    angle: { value: 0.58, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 16.0, min: 0, max: 100, step: 0.01 },
    decay: { value:0.6, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    target: { value: [0.1, 0.11, -0.18], step: 0.01 },
    angle: { value: 0.41, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 16.0, min: 0, max: 100, step: 0.01 },
