...
export const LightsDarkA = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.0, 1.22, 3.46], step: 0.01 },
    target: { value: [0.01, 0.36, 0], step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.02 ,1.41, -2.87], step: 0.01 },
    target: { value:  [0, 0.65, 0], step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.29, 1.98, -0.10], step: 0.01 },
    target: { value: [-60.82, -32.00, -2.36], step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-2.29, 2, 0.64], step: 0.01 },
    target: { value: [0.53, 0.60, -0.21], step: 0.01 },
