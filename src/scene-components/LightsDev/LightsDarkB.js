...
export const LightsDarkB = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.0, 1.22, 3.28], step: 0.01 },
    target: { value: [0.01, 0.46, 0], step: 0.01 },
    angle: { value: 0.45, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value:  0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value:21.00, min: 0, max: 100, step: 0.01 },
    decay: { value: 1, min: 0, max: 2, step: 0.01 },
    distance: { value: 5.81, min: 0, max: 100, step: 0.01 },
  ...
  const spotlight2 = useControls("Spotlight 2", {
    ...
    decay: { value: 0.70, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.02 ,1.60, -2.87], step: 0.01 },
    target: { value:  [0, 0.79, 0], step: 0.01 },
    angle: { value: 0.37, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 22.10, min: 0, max: 100, step: 0.01 },
    decay: { value:  0.94, min: 0, max: 2, step: 0.01 },
    distance: { value: 4.6, min: 0, max: 100, step: 0.1 },
    shadowMapWidth: { value: 1080, min: 256, max: 4096, step: 1 },
    shadowMapHeight: { value: 1080, min: 256, max: 4096, step: 1 },
    shadowCameraNear: { value: 1, min: 0.1, max: 10, step: 0.1 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.29, 2.01, -0.10], step: 0.01 },
    target: { value: [-60.82, -30.68, -2.36], step: 0.01 },
    angle: { value: 0.40, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 13.0, min: 0, max: 100, step: 0.01 },
    decay: { value:0.9, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-2.29, 2.12, 0.64], step: 0.01 },
    target: { value: [0.53, 0.64, -0.21], step: 0.01 },
    angle: { value: 0.33, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 13.0, min: 0, max: 100, step: 0.01 },
    decay: { value: 0.90, min: 0, max: 2, step: 0.01 },
    distance: { value: 3, min: 0, max: 100, step: 0.01 },
    shadowMapWidth: { value: 1080, min: 256, max: 4096, step: 1 },
    shadowMapHeight: { value: 1080, min: 256, max: 4096, step: 1 },
    shadowCameraNear: { value: 1, min: 0.1, max: 10, step: 0.1 },
