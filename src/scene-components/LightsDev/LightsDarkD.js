...
export const LightsDarkD = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.0, 1.28, 3.64], step: 0.01 },
    target: { value: [0.01, 0.52, 0], step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.02 ,1.42, -2.87], step: 0.01 },
    target: { value:  [0, 0.98, 0], step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.34, 1.98, 0.10], step: 0.01 },
    target: { value: [-60.82, -25.10, -2.36], step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-2.29, 2.04, 0.64], step: 0.01 },
    target: { value: [0.53, 0.93, -0.21], step: 0.01 },
