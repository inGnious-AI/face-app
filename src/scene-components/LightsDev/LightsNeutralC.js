...
export const LightsNeutralC = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.3, 1.93, 3.60], step: 0.01 },
    target: { value: [0, 0.90, 0], step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-0.45, 1.91, -5.21], step: 0.01 },
    target: { value:  [-0.07, 0.53, 0], step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.44, 1.59, 1.03], step: 0.01 },
    target: { value: [-77.22, -33.67, -33.6], step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-3.21, 1.03, 3.18], step: 0.01 },
    target: { value: [0.1, 0.34, -0.18], step: 0.01 },
    angle: { value: 0.41, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
