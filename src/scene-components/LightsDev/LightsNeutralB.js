...
export const LightsNeutralB = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.3, 1.82, 3.60], step: 0.01 },
    target: { value: [0, 0.55, 0], step: 0.01 },
    angle: { value: 0.4, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value:  0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value:17.66, min: 0, max: 100, step: 0.01 },
    decay: { value: 1.87, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-0.45, 1.91, -5.12], step: 0.01 },
    target: { value:  [-0.07, 0.44, 0], step: 0.01 },
    angle: { value: 0.41, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 39.91, min: 0, max: 100, step: 0.01 },
    decay: { value:  1.29, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.36, 1.58, 0.97], step: 0.01 },
    target: { value: [-77.22, -34.40, -33.60], step: 0.01 },
    angle: { value: 0.55, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 17.0, min: 0, max: 100, step: 0.01 },
    decay: { value:0.5, min: 0, max: 2, step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-2.78, 1.35, 3.21], step: 0.01 },
    target: { value: [-0.02, 0.50, -0.18], step: 0.01 },
    angle: { value: 0.41, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
    intensity: { value: 16.0, min: 0, max: 100, step: 0.01 },
    decay: { value: 1.25, min: 0, max: 2, step: 0.01 },
