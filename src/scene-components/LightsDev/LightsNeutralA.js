...
export const LightsNeutralA = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.3, 2.78, 3.08], step: 0.01 },
    target: { value: [0, 0.39, 0], step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.0, 1.81, -5.21], step: 0.01 },
    target: { value:  [0, 1.33, 0], step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.29, 1.26, 1.17], step: 0.01 },
    target: { value: [-61.56, -24.77, -33.6], step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    target: { value: [0.1, 0.21, -0.18], step: 0.01 },
    angle: { value: 0.41, min: 0, max: Math.PI / 2, step: 0.01 },
    penumbra: { value: 0.9, min: 0, max: 1, step: 0.01 },
