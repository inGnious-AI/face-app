...
export const LightsDarkC = ({ lightColor }) => {
  ...
  const spotlight1 = useControls("Spotlight 1", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.0, 1.29, 3.28], step: 0.01 },
    target: { value: [0.01, 0.58, 0], step: 0.01 },
  ...
  const spotlight3 = useControls("Spotlight 3", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [0.02 ,1.62, -3.11], step: 0.01 },
  ...
  const spotlight4 = useControls("Spotlight 4", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [2.29, 0.01, -0.10], step: 0.01 },
  ...
  const spotlight5 = useControls("Spotlight 5", {
    ...
    castShadow: true,
    helper: false,
    position: { value: [-2.29, 2.12, 1.05], step: 0.01 },
    target: { value: [0.57, 0.77, -0.26], step: 0.01 },
